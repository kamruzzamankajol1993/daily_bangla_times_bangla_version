        ...
        <div class="row g-4">
                ...
                @if(isset($lawCourtsNews) && count($lawCourtsNews) > 0)
                    ...
                    <div class="card border-0 shadow-sm mb-3">
                        <div class="position-relative">
                            <img src="{{ $mainLaw->image ? $front_admin_url.$mainLaw->image : 'https://placehold.co/400x250/555/fff?text=Law' }}" 
                        ...
                        <div class="card-body p-3">
                            <h5 class="card-title fw-bold hover-red">
                                <a href="{{ route('front.product.details', $mainLaw->slug) }}" class="text-dark text-decoration-none hover-red">
                                    {{ $mainLaw->title }}
                                </a>
                            </h5>
            ...
            <div class="col-lg-4">
                ...
                @if(isset($exclusiveNews) && count($exclusiveNews) > 0)
                    ...
                    <div class="card border-0 shadow-sm mb-3">
                        <div class="position-relative">
                            <img src="{{ $mainExclusive->image ? $front_admin_url.$mainExclusive->image : 'https://placehold.co/400x250/222/fff?text=Exclusive' }}" 
                                 class="card-img-top rounded-0" 
                        ...
                        <div class="card-body p-3">
                            <h5 class="card-title fw-bold hover-red">
                                <a href="{{ route('front.product.details', $mainExclusive->slug) }}" class="text-dark text-decoration-none hover-red">
                                    {{ $mainExclusive->title }}
                                </a>
                            </h5>
                            <p class="card-text small text-secondary text-justify">
            ...
            <div class="col-lg-4">
                ...
                @if(isset($healthNews) && count($healthNews) > 0)
                    ...
                    <div class="card border-0 shadow-sm mb-3">
                        <div class="position-relative">
                            <img src="{{ $mainHealth->image ? $front_admin_url.$mainHealth->image : 'https://placehold.co/400x250/000/fff?text=Health' }}" 
                                 class="card-img-top rounded-0" 
                        ...
                        <div class="card-body p-3">
                            <h5 class="card-title fw-bold hover-red">
                                <a href="{{ route('front.product.details', $mainHealth->slug) }}" class="text-dark text-decoration-none hover-red">
                                    {{ $mainHealth->title }}
                                </a>
                            </h5>
                            <p class="card-text small text-secondary text-justify">
